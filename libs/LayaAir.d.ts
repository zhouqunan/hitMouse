...
declare module laya.d3.animation {
    ...
    class AnimationClip extends Resource {
        ...
        _nodes: Array<any>;
        _cacheUnTransformPropertyToNodeMap: Int32Array;
        _cacheNodeToUnTransformPropertyMap: Int32Array;
        _duration: number;
        _frameRate: number;
        /**
         ...
         * @private
         */
        _evaluateAnimationlDatasCacheFrame(nodesFrameIndices: Array<any>, frameIndex: number, playCurTime: number, cacheNodesOriginalValue: Array<any>, publicAnimationDatas: Array<any>, cacheAnimationDatas: Array<any>): void;
        /**
         * @private
         */
...
declare module laya.d3.component {
    ...
    class Animator extends Component3D implements IDestroy {
         ...
         */
        constructor();
        private _setAnimationProperty(nodeOwners, publicClipAnimatioDatas);
        /**
         *@private
         */
        _updateAnimation(avatarAnimationDatas: Array<any>): void;
        /**
         *@private
         */
        _updateAnimationCache(avatarAnimationDatas: Array<any>): void;
        /**
         * @private
         */
         ...
         */
        play(name?: string, loop?: boolean, playbackRate?: number, startFrame?: number, endFrame?: number): void;
        /**
         * 停止播放当前动画
         * @param	immediate 是否立即停止
         */
